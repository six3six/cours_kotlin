...
class JokeAdapter: RecyclerView.Adapter<JokeAdapter.JokeViewHolder>() {
    ...
    inner class JokeViewHolder(val constraintLayout: ConstraintLayout) : RecyclerView.ViewHolder(constraintLayout){
        fun updateJoke(text:String){
            val constraintValue: TextView = constraintLayout.findViewById<TextView>(R.id.textView_joke_layout)
